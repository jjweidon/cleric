  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <header className="p-4 flex justify-between items-center border-b">
        <div className="text-xl font-bold text-primary">Cleric</div>
      ...
      <main className="flex-1 p-4">
        ...
        <div className="bg-white rounded-lg border p-4 mb-4">
          <h3 className="font-medium mb-3">최근 상담 내역</h3>
        ...
        <div className="bg-white rounded-lg border p-4">
          <h3 className="font-medium mb-3">AI 상담하기</h3>
          <button className="w-full py-3 bg-blue-500 text-white rounded-lg flex items-center justify-center">
